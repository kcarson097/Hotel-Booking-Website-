...
//get the property id of the recent insert
$propID = $data['PropertyID'];
//echo "HELLOOOOOO".$propID;

//loop through amenities list and insert into prop amenities table via the api
if(isset($ammens)){
...
<section id = "main">
  ...
  <div class="container">
	<div class="d-flex justify-content-center">
        ...
        <?php
        echo "
        <p class = 'logouttext'>You have successfully created the listing<a href = 'index.php' >&nbspClick here to go home</a></p>
