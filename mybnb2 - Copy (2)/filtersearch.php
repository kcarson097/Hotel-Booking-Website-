...
//check if the user has selected filters from all options
if(isset($_POST['proptype'],$_POST['cancelpolicy'],$_POST['amenities'])){
    ...
    $_SESSION['proptype'] = $propType;
    $_SESSION['cancelpolicy'] = $cancelPolicy;
    $_SESSION['amenities'] = $amenities;
    //reset the city and guests var
    $_SESSION['mybnbcity'] = $city;
    $_SESSION['mybnbguests'] = $guests;
}

//3s - 4 diff combinations
//all filters selected bar amenities
else if(isset($_POST['proptype'],$_POST['cancelpolicy'])){
    $propType = $_POST['proptype'];
    $cancelPolicy = $_POST['cancelpolicy'];
    $city = $_SESSION['mybnbcity'];
    $guests = $_SESSION['mybnbguests'];
...
else if(isset($_POST['proptype'],$_POST['amenities'])){
    $propType = $_POST['proptype'];
    $amenities = $_POST['amenities'];
    $city = $_SESSION['mybnbcity'];
    $guests = $_SESSION['mybnbguests'];
...
//all filters selected bar beds
else if(isset($_POST['cancelpolicy'],$_POST['amenities'])){
    $cancelPolicy = $_SESSION['cancelpolicy'];
...
//proptype and cancelpolicy
else if(isset($_POST['cancelpolicy'])){
    $cancelPolicy = $_POST['cancelpolicy'];
    $city = $_SESSION['mybnbcity'];
    $guests = $_SESSION['mybnbguests'];
    session_unset();
...
if(isset($_SESSION['proptype'],$_SESSION['cancelpolicy'],$_SESSION['amenities'])){
    $endpoint = "http://kcarson09.lampt.eeecs.qub.ac.uk/mybnbapi/filtering/filters.php?location={$_SESSION['mybnbcity']}&accomodates={$_SESSION['mybnbguests']}&page={$page}&";
...
//proptype 
else if(isset($_SESSION['proptype'],$_SESSION['mybnbcity'])){//check if city is set also as there is a possibilty you are filtering a search when the user selects prop type from index page
  $endpoint = "http://kcarson09.lampt.eeecs.qub.ac.uk/mybnbapi/filtering/filters.php?location={$_SESSION['mybnbcity']}&accomodates={$_SESSION['mybnbguests']}&page={$page}&";
  $finalEndpoint = buildURLString($_SESSION['proptype'],"proptype[]",$endpoint);
  echo $finalEndpoint;
  $result = file_get_contents($finalEndpoint);
...
// else if(isset($_SESSION['proptype'])){
//     $endpoint = "http://kcarson09.lampt.eeecs.qub.ac.uk/mybnbapi/searches/propertytype.php?page={$page}&";
...
echo "
      <ul class='pagination d-flex justify-content-center'> 
          <li class='page-item'>
          <a class='page-link' href='filtersearch.php?page=1&rand=$num'>First</a>
          </li>";
  ...
  for($i=$startPage;$i<=$endpage;$i++){//generate links to page from start to end page
    echo "<li class='page-item'><a class='page-link' href='filtersearch.php?page=$i&rand=$num'>$i</a></li>";
  }
  echo "<a class='page-link' href='filtersearch.php?page=$numberpages&rand=$num'>Last</a>";
