<?php
    ...
    //delete the entry
    $endpoint = "http://kcarson09.lampt.eeecs.qub.ac.uk/mybnbapi/bookings/deletebooking.php?userID={$_SESSION['userID']}&propID={$PropertyID}&startdate={$start}&enddate={$end}";
    //echo $endpoint;
...
<section id = "main">
  ...
  <div class="container">
	<div class="d-flex justify-content-center">
        ...
        <?php
        echo "
        <p class = 'logouttext'>You have successfully cancelled your booking<a href = 'mybookings.php' >&nbspClick here to go back</a></p>"
        ?>
         </div>
    </div>
    </div>
