...
//get the posted propID
if(isset($_POST['propID'])){
  $propID = $_POST['propID'];
  //delete the listing and also all the amenities in the prop amenities table as well as any appearences in favourites/bookings table
  $endpoint = "http://kcarson09.lampt.eeecs.qub.ac.uk/mybnbapi/admin/deletelisting.php?propID='{$propID}'";
  $result = file_get_contents($endpoint);
  $data = json_decode($result,true);
  //header("Location: deleteproperty.php");
}
//echo $propID;
...
<section id = "main">
  ...
  <div class="container">
	<div class="d-flex justify-content-center">
        ...
        <?php
        echo "
        <p class = 'logouttext'>You have successfully deleted the listing<a href = 'index.php' >&nbspClick here to go home</a></p>";
        ?>
         </div>
    </div>
    </div>
